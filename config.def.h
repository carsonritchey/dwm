...
/* tagging */
static const char *tags[] = { "一", "ニ", "三", "四", "五", "六"};
...
static Key keys[] = {
	...
	// { MODKEY,                       XK_i,      incnmaster,     {.i = +1 } }, disabled because of conflicts and i honestly dont know what they do anyways
	...
	/* awesomebar hotkeys (disabled because of conficts)
	{ MODKEY,                       XK_s,      show,           {0} },
	{ MODKEY,                       XK_h,      hide,           {0} },
	*/
	TAGKEYS(                        XK_1,                      0)
	...
	/* custom command implimentations */
